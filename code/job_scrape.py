...
if __name__ == "__main__":
    ...
    filter_params = {
        'area': '6001001000,6001002000,6001005000,6001008000,6001010000,6001014000,6001016000',  # (地區) 
        's9': '1',  # (上班時段) 日班
        'isnew': '0',  # (更新日期) 0:本日最新 
        'jobexp': '1',  # (經歷要求) 1年以下
        'edu': '2,3,4,5,6',  # (學歷要求) 高中職以下,高中職,專科,大學,碩士,博士
        'excludeJobKeyword': '科技',  # 排除關鍵字
        'kwop': '1',  # 只搜尋職務名稱
        'jobcat': '2007000000',  # (職務類別) 資訊軟體-程式設計師
